...
namespace Plugin\ExternalPaymentGateway\Entity;

/**
 * Information about each payment method in External module
 * (Substituion for dtb_payment in Eccube 2)
 */
class ExternalPaymentMethod extends \Eccube\Entity\AbstractEntity
{
    /**
     * @return string
     */
